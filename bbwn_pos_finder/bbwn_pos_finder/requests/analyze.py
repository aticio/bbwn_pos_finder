...
def build_analyze_request(parameters=None):
    accepted_parameters = ["symbol", "interval", "bbwn_length", "bbwn_std", "ssf_length_1", "ssf_length_2"]
    ...
    if parameters is not None:
        ...
        invalid_req.add_error("parameters", "Need 6 parameters: symbol, interval, start_date, end_date. Got 0.")
        return invalid_req
